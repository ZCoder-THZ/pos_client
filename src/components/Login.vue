<template>
    <div class="flex flex-col items-center bg-green-500 justify-center h-screen">
        <div class="flex rounded shadow-md shadow-black flex-col border border-green-400 bg-white text-green-700 p-8">
            ...
            <input class="my-3 border-2 border-green-500 py-2 rounded px-4 focus:outline-none" type="email" id=""
            ...
            <input class="my-3 border-2 border-green-500 py-2 rounded px-4 focus:outline-none" type="password"
                v-model="password" id="" placeholder="Enter Password">
            <span v-if="password == ''">Enter Passowrd</span>

            <div class="flex justify-between">
                <button class="text-green text-lg text-bold mt-3 hover:underline" @click="login"> Log In</button>
                <router-link class="text-green text-lg text-bold mt-3 hover:underline" to="/register"> Register
                </router-link>
            </div>
