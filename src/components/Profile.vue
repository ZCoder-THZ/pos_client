                    ...
                    <div class="px-6">
                        ...
                        <div class="text-center mt-12">
                            ...
                            <div class="mb-2 text-blueGray-600 mt-10">
                                <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>Email:
                                {{ userProfile.email }}
                            </div>
                            <div class="mb-2 text-blueGray-600">
                                <i class="fas fa-university mr-2 text-lg text-blueGray-400"></i>Phone:
                                {{ userProfile.phone }}}
                            </div>
                            <div class="mb-2 text-blueGray-600">
                                <i class="fas fa-university mr-2 text-lg text-blueGray-400"></i>Gender :
                                {{ userProfile.gender }}
                            </div>
                        </div>
                        <div class="mt-10 py-10 border-t border-blueGray-200 text-center">
                            <div class="flex flex-wrap justify-center">
                                <div class="w-full lg:w-9/12 px-4">
                                    ...
                                    <a href="#pablo" class="font-normal text-pink-500">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
