  ...
  <div
    ...
    <div
      ...
      <div class="flex items-end lg:flex-row flex-col justify-end" id="cart">
        <div
          class="lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800  overflow-x-hidden lg:h-screen h-auto"
          id="scroll">
        ...
        <div class="lg:w-96 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 h-full">
          <div
            ...
            <div>
              ...
              <button @click="checkAlert">show Alert</button>
            </div>
          </div>
        </div>
      </div>
