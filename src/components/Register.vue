                ...
                <div class="bg-black">
                    <div class="w-screen  flex items-center justify-center">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                           ...
                           <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Gender</label>
                        ...
                        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="accountRegister">Submit</button>
                    </div>
                    </div>
                </div>
...
const { username, password, email, gender, phone, password2,address,erorrPassword,accountRegister} = register();

let create=()=>{
    console.log(username.value,gender.value,address.value)
}
</script>
